...
def home(request):
    ...
    return render(request, 'designpro/home.html', {
...
def user_login(request):
    ...
    return render(request, 'designpro/login.html')
...
def user_register(request):
    ...
    return render(request, 'designpro/register.html', {'form': form})
...
def create_application(request):
    ...
    return render(request, 'designpro/create_application.html', {
...
def user_applications(request):
    ...
    return render(request, 'designpro/user_profile.html', {
...
def delete_application(request, app_id):
    ...
    return render(request, 'designpro/user_profile.html', {'application': app})
...
def admin_dashboard(request):
    ...
    categories = Category.objects.all()
    return render(request, 'designpro/admin_dashboard.html', {
        'applications': applications,
        'categories': categories,
        'status_filter': status_filter,
    })
